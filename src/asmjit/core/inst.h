...
public:
  ...
  //!
  //! Default values of `id` and `options` are zero, which means none instruciton. Such instruction is guaranteed to
  //! never exist for any architecture supported by AsmJit.
